...
var term_comet2 = $('#terminal_comet2').terminal({
  break: function (addr) {
  ...
  reload: function () {
    comet2init(`Reloading program ... done.`);
  },
  re: function () {
    comet2init(`Reloading program ... done.`);
  },
  info: function () {
    cmd_info(comet2mem, state, []);
  },
  i: function () {
    cmd_info(comet2mem, state, []);
  },
  delete: function (arg) {
    cmd_delete(comet2mem, state, [arg]);
  },
  d: function (arg) {
    cmd_delete(comet2mem, state, [arg]);
  },
  disasm: function (addr) {
    cmd_disasm(comet2mem, state, [addr]);
  },
  di: function (addr) {
    cmd_disasm(comet2mem, state, [addr]);
  },
  stack: function () {
    cmd_stack(comet2mem, state, []);
  },
  st: function () {
    cmd_stack(comet2mem, state, []);
  },
  dump: function (addr) {
    cmd_dump(comet2mem, state, [addr]);
  },
  du: function (addr) {
    cmd_dump(comet2mem, state, [addr]);
  },
  jump: function (addr) {
    cmd_jump(comet2mem, state, [addr]);
  ...
  memory: function (addr, value) {
    cmd_memory(comet2mem, state, [addr, value]);
    if (!opt_q) cmd_print(comet2mem, state, []);
  },
  m: function (addr, value) {
    cmd_memory(comet2mem, state, [addr, value]);
    if (!opt_q) cmd_print(comet2mem, state, []);
  },
  h: function () {
    cmd_help(comet2mem, state, []);
  },
  help: function () {
    cmd_help(comet2mem, state, []);
  },
